...
| **Target reminders** (`targetRemindersEnabled`) | off | A person sets a daily or weekly target of their own and chooses when to be reminded. The reminder comes only on their working days and only if they recorded less. It goes only to them. Nobody sees who was reminded, no reminder is audited, and administrators can only suggest a target. | Nobody else gets a report. Whether a target is suggested, and which, still belongs in the agreement. |
